...
REQUIRED_FILES = [
    ...
    "scripts/mechanics_claim_audit.py",
    "scripts/eval_schema_check.py",
    "scripts/eval_run.py",
    "scripts/evaluation_program_check.py",
    "scripts/eval_harness/__init__.py",
    "scripts/eval_harness/core.py",
    "scripts/eval_harness/providers.py",
    ...
    "schemas/evidence-authorities.schema.json",
    "schemas/evidence-capture.schema.json",
    "schemas/evidence-claim.schema.json",
    "schemas/evidence-policy.schema.json",
    "schemas/evidence-runtime-map.schema.json",
    "schemas/evidence-source.schema.json",
    "docs/V7_EVIDENCE_MIGRATION.md",
    "docs/V7_SURFACE_PROFILE_MIGRATION.md",
    "docs/V7_LANGUAGE_RENDERING_MIGRATION.md",
    "docs/V7_PHYSICS_MOTION_STATE_MIGRATION.md",
    ...
    "agents/openai.yaml",
    "evals/evals.json",
    "evals/eval-suite-v2.schema.json",
    "evals/suites/development.json",
    "evals/suites/live.json",
    "evals/held-out/README.md",
    ...
    "docs/V7_EVAL_HARNESS_MIGRATION.md",
