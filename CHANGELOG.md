...
- Expanded the installable runtime to 125 files. Four profile files remain `mapped_candidate`, 28 files contain no volatile claims, 93 inherited files remain `legacy_blocked`, and activation remains disabled.
