...
- every v2 clip is `compile_required`; use only a compiler that accepts that exact contract. V7-07 does not, so fail closed instead of flattening v2 state or hand-editing a paired render;
